# Feature 06 — Métriques heuristiques d’évaluation

## Identité

- **Code** : `06_heuristic_evaluation_metrics`
- **Branche recommandée** : `feature/heuristic-evaluation`
- **Dépendances** : 01_project_bootstrap, 02_core_deck_model, 05_deck_statistics_and_aggregates

## Objectif

Implémenter les premières métriques heuristiques indépendantes et explicables pour évaluer un deck sans moteur de simulation.

## Livrables attendus

- Domaine `evaluation` de base
- Évaluateurs pour courbe de mana, ratio de terrains, équilibre des couleurs, cohérence mana base, équilibre des types
- Scores bruts et normalisés par métrique
- Explications textuelles par métrique
...
- Une batterie de tests par évaluateur
- Cas favorables, neutres et défavorables
- Explications produites

## Critères d’acceptation

- Chaque métrique est indépendante, nommée et pondérable
- Chaque métrique produit score brut, normalisé et explication
- Aucune dépendance au moteur de règles
